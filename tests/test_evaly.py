...
class TestEvaly(BaseTest):
    ...
    # Case 1
    def test_01_sign_in(self): # TODO 0: Look for the solution of webdriver getting detected.
        print("\n" + str(test_cases(0)))
    ...
    def test_03_products(self): #TODO 1: Create excel from list of dictionaries.
        speaker_page = HomePage(self.driver).click_speaker_link()
